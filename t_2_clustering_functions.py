...
def cluster(data, n_clusters=2):
    """
    Perform clustering on the given data excluding the 'arrival_timestamp' column.
    ...
    # Step 6: Visualize the clusters (optional, for 2D data)
    ...
    for i in range(n_clusters):
        ...
        filtered_df.to_csv(f'data/traces/endpoint1/functions/function{i}.csv', index=False)

if __name__ == "__main__":
    data = pd.read_csv("data/traces/endpoint1/e1.csv")
